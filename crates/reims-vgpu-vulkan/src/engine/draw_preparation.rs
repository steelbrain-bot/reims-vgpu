...
use crate::m2v_cache::M2vCacheDecline;
use crate::preparation::{IndexLoadReason, MtlbDecline, PastTableBind, SecondaryMrtRefusal};
...
pub enum DrawPreparationDecline {
    ...
    /// there before. See
    /// [`crate::preparation::MrtDrop`] for which checks bail
