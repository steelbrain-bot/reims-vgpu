...
pub use resource::{
    ...
    ObjectKind, ObjectListDecodeError, ObjectListDependency, ObjectListEntry,
    RasterizationRateMapDescriptor, RasterizationRateMapLayerDescriptor, RenderPipelineDescriptor,
    RenderPipelineObject, ResourceDecodeError, ResourceDescriptor, SamplerDescriptor,
    SamplerObject, SurfaceBackingDescriptor, SurfaceBackingPlane, SurfacePlaneLayoutError,
    TextureLevelLayout, TextureViewDescriptor, TextureViewForm, VertexAttribute, CUBE_FACES,
    MAX_COLOR_ATTACHMENTS, MTL_COLOR_WRITE_MASK_ALL, MTL_COLOR_WRITE_MASK_ALPHA,
